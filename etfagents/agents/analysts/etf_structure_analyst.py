...
def create_etf_structure_analyst(llm):
    def etf_structure_node(state):
        ...
        system_message = (
            ...
            "## Report structure\n"
            "The report has three top-level sections (一、二、三). Each must begin with a 帽段 (hat paragraph) — "
            "2-3 sentences summarizing the key conclusions of that section before sub-sections展开. "
            ...
            "二、矛盾推演\n"
            "[Hat paragraph: 2-3 sentences summarizing the identified conflicts and their combined implication.]\n\n"
            ...
            "  - Contracts involved and their combined signal direction\n"
            "  - Macro/industry opportunity or problem, with conviction level\n"
            ...
            "三、情景推演与策略启示\n"
            "[Hat paragraph: 2-3 sentences stating the overall strategic takeaway.]\n\n"
