...
def create_stock_research_analyst(llm):
    def stock_research_node(state):
        ...
        system_message = (
            ...
            "一、总体研判 (Overview)\n"
            "[Hat paragraph: summarize the most important consensus view or divergence]\n\n"
            "  （一）共识观点 (Consensus View)\n\n"
            "  （二）核心分歧 (Key Divergences)\n\n"
            "二、深度分析 (In-Depth Analysis)\n"
            "[Hat paragraph: summarize the most critical quantitative, earnings, or valuation finding]\n\n"
            ...
            "[Hat paragraph: summarize the top risk and catalyst]\n\n"
            "  （一）盲点与遗漏问题 (Blind Spots & Missing Questions)\n\n"
            "  （二）关键催化剂 (Key Catalysts)\n\n"
            "  （三）风险提示 (Risk Factors)\n\n"
            "四、总结 (Summary)\n"
            "[Hat paragraph: synthesize the bottom-line portfolio impact]\n\n"
