        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "In the ETF allocation thesis, explain why the current macro, industry, holdings, and flow evidence leads to this exposure stance; do not simply restate the execution steps, sizing bands, or trigger thresholds. "
                    "In the execution plan, focus on what to do, at what levels, and under which confirmation or invalidation triggers; do not repeat the thesis sentence verbatim. "
                    "In rebalance and risk controls, focus on failure conditions, rebalance triggers, cut or restore rules, and what must be monitored next; do not repeat the thesis or execution sentence verbatim. "
